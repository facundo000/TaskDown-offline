    ...
    taskDiv.innerHTML = `
      ...
      <div class="task-actions">
        <div class="task-buttons">
          <button class="decrement-btn" data-task-id="${task.id}" ${task.current_count <= 0 ? 'disabled' : ''} title="Decrementar en 1">
            -1
          </button>
          <button class="reset-btn" data-task-id="${task.id}" title="Restablecer al valor inicial (${task.initial_count})">
            ↻
          </button>
          ...
          <button class="details-btn" data-task-id="${task.id}" title="Ver detalles en la app">
